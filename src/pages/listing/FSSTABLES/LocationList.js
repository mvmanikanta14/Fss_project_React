...
const LocationList = () => {
  ...
  function handleRemove(id) {
    ...
    if (shouldRemove) {
        ...
        console.log(data,"datata")
         CommonService.patch(apiUrlsService.updateLocationlist + id, data).then(
        (response) => {
          if (response) {
  ...
  const onSubmit = (data) => {
   console.log(ids,"this is add or edit data")
    ...
    if (!ids) {
      ...
      data.id = editData.id;
      CommonService.patch(
        apiUrlsService.updateLocationlist + editData.id,
        data
      ).then(
        (response) => {
          if (response) {
      ...
      <div className="container-fluid pl-2 pr-2">
        <div className="row">
          <div className="col-md-12 bg-white bordered headerdiv">
            ...
            <div className="header-title">Type Location List</div>
          </div>
